...
echo -n "in" > /sys/class/gpio/gpio70/direction
...
echo -n "in" > /sys/class/gpio/gpio74/direction
...
echo -n "in" > /sys/class/gpio/gpio72/direction
...
echo -n "in" > /sys/class/gpio/gpio42/direction
